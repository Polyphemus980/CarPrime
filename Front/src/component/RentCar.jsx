// src/component/RentCar.jsx
import React, { useState, useEffect, useContext } from 'react';
import axios from '../axiosConfig';
import { toast } from 'react-toastify';
import './RentCar.css';
import { UserContext } from '../context/UserContext';
import RentalForm from './RentalForm'; // Ensure this component exists
...
function RentCar() {
  ...
  const fetchCars = async () => {
    ...
    try {
      const res = await axios.get(
        'https://carprimeapi-cddtdnh9bbdqgzex.polandcentral-01.azurewebsites.net/cars'
      );
      setCars(res.data);
    } catch (error) {
  ...
  const handleRentSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        `https://carprimeapi-cddtdnh9bbdqgzex.polandcentral-01.azurewebsites.net/Car/${rentingCarId}/rent`,
        rentData
      );
  ...
  if (loading) {
    return <div className="spinner">Loading cars...</div>;
  }
